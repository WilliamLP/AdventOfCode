...
strs = open('day22_test.txt').readlines()
...
def make_step(pos_i, pos_j, dir, test=False):
    ...
    new_dir = dir
    block_i, block_j = pos_i // 4, pos_j // 4

    if new_pos_i < min_i[pos_j]:
        if block_j == 0:
            new_pos_i, new_pos_j = 0, 3 - pos_j + 8
            new_dir = (1, 0)
        elif block_j == 1:
            new_pos_i, new_pos_j = pos_j - 4, 8
            new_dir = (0, 1)
        elif block_j == 2:
            new_pos_i, new_pos_j = 4, 11 - pos_j
            new_dir = (1, 0)
        elif block_j == 3:
            new_pos_i, new_pos_j = 15 - pos_j + 4, 11
            new_dir = (0, -1)
        else:
        ...
        if block_j == 0:
            new_pos_i, new_pos_j = 11, 3 - pos_j + 8
            new_dir = (-1, 0)
        elif block_j == 1:
            new_pos_i, new_pos_j = 7 - pos_j, 8
            new_dir = (0, 1)
        elif block_j == 2:
            new_pos_i, new_pos_j = 7, 11 - pos_j
            new_dir = (-1, 0)
        elif block_j == 3:
            new_pos_i, new_pos_j = 15 - pos_j + 4, 0
            new_dir = (0, 1)
        else:
            raise Exception('Invalid edge')
        ...
        if block_i == 0:
            new_pos_i, new_pos_j = 4, pos_i + 4
            new_dir = (1, 0)
        elif block_i == 1:
            new_pos_i, new_pos_j = 11, 7 - pos_i + 12
            new_dir = (-1, 0)
        elif block_i == 2:
            new_pos_i, new_pos_j = 7, 11 - pos_i + 4
            new_dir = (-1, 0)
        else:
            raise Exception('Invalid edge')
        ...
        if block_i == 0:
            new_pos_i, new_pos_j = 11 - pos_i, 11
            new_dir = (0, -1)
        elif block_i == 1:
            new_pos_i, new_pos_j = 8, 7 - pos_i + 12
            new_dir = (1, 0)
        elif block_i == 2:
            new_pos_i, new_pos_j = 7, 11 - pos_i + 4
            new_dir = (-1, 0)
...
for step, rotation in cmds:
    ...
    print(pos_i + 1, pos_j + 1, dir, step, rotation)
    if rotation == 'R':
        dir = (dir[1], -dir[0])
    elif rotation == 'L':
        dir = (-dir[1], dir[0])
